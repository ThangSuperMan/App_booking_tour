                ...
                <div className="login-page">
                    <div className="login-main">
                        ...
                        <div className="frame-login">
                            ...
                            <div>
                                <input type="submit" value="Bạn quên mật khẩu?" className="btn-forget-password"></input>
                            </div>
                            <div>
                                <input type="submit" value="Đăng nhập" className="btn-login"></input>
                            </div>
                        </div>
                    </div>
                    <div className="login-main2">
                        ...
                        <Link to="/signup" className="link-to-signup">Đăng ký</Link>
                    </div>
                </div>
            </div>
        )
